...
require_once "../db.php";
 ...
 $user_name  =   $_REQUEST['vendor_name'];
        ...
        // if everything is ok, try to upload file
        } else 
            {
                if (move_uploaded_file($_FILES["prd_image"]["tmp_name"], $target_file)) {
                    ...
                    $sql = "INSERT INTO boutique_post (category_id,prd_image, prd_name,prd_price,prd_qty,vendor_city,vendor_id,vendor_name,prd_desc,prd_quality)
                    VALUES ('$category_id', '$prd_image', '$prd_name','$prd_price','$prd_qty','$vendor_city','$vendor_id','$vendor_name','$prd_desc','$prd_quality')";
