...
$customer_name    =   $_REQUEST['customer_name'];
 ...
 $sql = "INSERT INTO cart (user_id,vendor_id, customer_name,user_cnic, address,user_contact,prd_name,vendor_city,prd_price,prd_quality,prd_qty,prd_desc,vendor_contact,total)
            VALUES ('$user_id', '$vendor_id','$customer_name', '$user_cnic','$user_address','$user_contact','$prd_name','$vendor_city','$prd_price','$prd_quality','$prd_qty','$prd_desc','$vendor_contact','$total')";
